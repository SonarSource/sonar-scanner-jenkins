...
public class SonarPublisher extends Notifier {
  ...
  public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws IOException, InterruptedException {
    ...
    if (isSkip(build, listener, sonarInstallation)) {
      SonarUtils.addBuildInfoFromLastBuildTo(build, listener, sonarInstallation, true);
      return true;
    }
    ...
    SonarUtils.addBuildInfoTo(build, listener, build.getWorkspace(), sonarInstallation);
